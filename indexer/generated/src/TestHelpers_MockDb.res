...
@genType
and entities = {
    @as("MultiTokenERC20_OwnershipTransferred") multiTokenERC20_OwnershipTransferred: entityStoreOperations<Entities.MultiTokenERC20_OwnershipTransferred.t>,
    @as("MultiTokenERC20_TokenCreated") multiTokenERC20_TokenCreated: entityStoreOperations<Entities.MultiTokenERC20_TokenCreated.t>,
    @as("MultiTokenERC20_TokensBurned") multiTokenERC20_TokensBurned: entityStoreOperations<Entities.MultiTokenERC20_TokensBurned.t>,
    @as("MultiTokenERC20_TokensMinted") multiTokenERC20_TokensMinted: entityStoreOperations<Entities.MultiTokenERC20_TokensMinted.t>,
  }
  ...
  let entities = {
      multiTokenERC20_OwnershipTransferred: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.multiTokenERC20_OwnershipTransferred,
          ~getKey=({id}) => id,
        )
      },
      multiTokenERC20_TokenCreated: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.multiTokenERC20_TokenCreated,
          ~getKey=({id}) => id,
        )
      },
      multiTokenERC20_TokensBurned: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.multiTokenERC20_TokensBurned,
          ~getKey=({id}) => id,
        )
      },
      multiTokenERC20_TokensMinted: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.multiTokenERC20_TokensMinted,
          ~getKey=({id}) => id,
        )
      },
  }
...
//ENTITY EXECUTION
  mockDb->executeRowsEntity(
    ~inMemoryStore,
    ~getInMemTable=self => {self.multiTokenERC20_OwnershipTransferred},
    ~getKey=entity => entity.id,
  )
  mockDb->executeRowsEntity(
    ~inMemoryStore,
    ~getInMemTable=self => {self.multiTokenERC20_TokenCreated},
    ~getKey=entity => entity.id,
  )
  mockDb->executeRowsEntity(
    ~inMemoryStore,
    ~getInMemTable=self => {self.multiTokenERC20_TokensBurned},
    ~getKey=entity => entity.id,
  )
  mockDb->executeRowsEntity(
    ~inMemoryStore,
    ~getInMemTable=self => {self.multiTokenERC20_TokensMinted},
    ~getKey=entity => entity.id,
  )
}
